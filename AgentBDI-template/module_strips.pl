...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Esta implementaci�n corresponde a la estrategia de planificaci�n STRIPS b�sica,
...
% planifiaci�n.
%
% Aclaraci�n: las metas alcanzadas se protegen con el prop�sito de
% provocar la falla del planificador ante un intento de deshacerlas
% (lo que conducir�a a un plan inv�lido en caso de no controlarse).
...
%
%
% Predicado implementando el algoritmo de planificaci�n STRIPS.
% Versi�n exportada.


strips(Metas, Plan):-
	dynamic_state_rels(EInicial), % Obtener la lista Init de creencias relevantes a la planificaci�n.
...
%
% Predicado implementando el algoritmo de planificaci�n STRIPS.
% Versi�n oculta, en la que se basa la versi�n exportada.
% Recibe como argumento el estado inicial, codificado como una lista
% de relaciones din�micas primitivas v�lidas en el estado.

strips(Metas, EInicial, Plan):-
              alcanzar_todas(Metas, EInicial, [], [], Plan, _),
	      !. % Para forzar una �nica soluci�n
...
% previamente y cuyas precondiciones est�n pendientes de ser logradas.
% Se emplea para controlar que la acci�n seleccionada en este paso no
% pertenezca a la pila, en cuyo caso se estar�a entrando en un
% ciclo.
...
alcanzar(Meta, EActual, Prot, ActionsHeap, PlanMeta, ELuegoPlanMeta):-
	       ...
	       not(ciclo(NomAcc)), % Control de ciclo espec�fico para este dominio.
...
% alcanza(-Accion, +Meta)
%
% Retorna una acci�n que alcanza la meta.
...
%
% Establece qu� acciones (de las descriptas en
...
% acci�n de "alto nivel" goto(PosDest), donde PosDest es una posici�n
% destino. Ver especificaci�n de goto/1 en
...
ejecutar(Accion, EActual, NuevoEActual):-
                 ...
                 % en esta instancia del algoritmo esto siempre va a ser as�.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TESTS (actualmente son inv�lidos)
%
%
%test(1, Plan):-
